...
int main()
{
    ...
    while (t--)
    {
        ...
        while (stt.size())
        {
            ...
            while (alls.size() && (*alls.begin()) < val)
            {
                auto it = alls.lower_bound(val);
                it--;

                ll valnow = -(*it);
                ll frnow = freq[valnow];

                alls.erase(it);
                stt.erase({frnow,valnow});
                ...
                if (par == parnow)
                {
                    ans += ((valnow + 1) / 2) * frnow;
                    ans2 += (valnow / 2) * frnow;
                }
                else
                {
                    ans += (valnow / 2) * frnow;
                    ans2 += ((valnow + 1) / 2) * frnow;
                }
            }
