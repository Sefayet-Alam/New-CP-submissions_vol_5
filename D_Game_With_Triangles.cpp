...
int main()
{
    ...
    while (t--)
    {
        ...
        {
            d--;
            if (p1 * 2 + p2 + 2 <= n && p2 * 2 + p1 + 2 <= m)
            {
                if (a[n - p1 - 1] - a[p1] >= b[m - p2 - 1] - b[p2])
                {
                    cans += a[n - p1 - 1] - a[p1];
                    p1++;
                }
            ...
            else if (p1 * 2 + p2 + 2 <= n && p2 * 2 + p1 + 1 <= m)
            {
                cans += a[n - p1 - 1] - a[p1];
                p1++;
            }
            else if (p1 * 2 + p2 + 1 <= n && p2 * 2 + p1 + 2 <= m)
            {
                cans += b[m - p2 - 1] - b[p2];
                p2++;
            }
            else if (p1 * 2 + p2 + 3 <= n && p2 > 0)
            {
                p2--;
                cans -= b[m - p2 - 1] - b[p2];
                cans += a[n - p1 - 1] - a[p1];
