...
/* Points tO CONSIDER
    ...
    -> Making obvious ler and upper bounds, and proving they are constructible.
...
int main()
{
    ...
    while (t--)
    {
        ...
        vector<ll> pref1(sz + 1, 0), pref2(sz + 1, 0);
        for (ll i = 1; i <= sz; i++)
        {
            pref1[i] = pref1[i - 1] + g[i - 1];
            pref2[i] = pref2[i - 1] + g[i - 1] * 1LL * i;
        }
