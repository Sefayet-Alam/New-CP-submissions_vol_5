...
int main()
{
    ...
    while (t--)
    {
        ...
        while (r<n2)
        {
            ...
            ll ch=s[r]-'a';
            ll cnt=lens.back().first;
            if(ch==lens.back().second){
                nowtot-=(cnt)/2;
                lens.pop_back();
                cnt++;
                lens.push_back({cnt,ch});
                nowtot+=(cnt)/2;
                r++;
            }
            else{
            ...
            ll beg=lens.front().first;
            ll chb=lens.front().second;
            lens.pop_front();
            nowtot-=(beg/2);
