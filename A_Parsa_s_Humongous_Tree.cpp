...
void dfs(ll vertex,ll par=0){
    ...
    for(ll child: g[vertex]){
        ...
        dfs(child,vertex);
        dp[0][vertex] += max(abs(A[0][vertex] - A[1][child]) + dp[1][child], dp[0][child] + abs(A[0][vertex] - A[0][child]));
        dp[1][vertex] += max(abs(A[1][vertex] - A[1][child]) + dp[1][child], dp[0][child] + abs(A[1][vertex] - A[0][child]));
    }
}
