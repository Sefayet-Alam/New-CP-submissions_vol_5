...
int main()
{
    ...
    while (t--)
    {
        ...
        while (q--)
        {
            ...
            int less_x = 0, greater_x = 0, less_cnt = 0, greater_cnt = 0, ans = 0;
            bool f = false;
            // debug(l, r, x);
            while (l <= r)
            {
                ...
                // debug(l, r, x, m, less_x, greater_x);
                while (less_x && greater_x)
                    less_x--, greater_x--, ans += 2;
            }
            if (!f || less_cnt >= x || greater_cnt > (n - x))
                cout << "-1 ";
            else
                cout << ans + 2 * greater_x + 2 * less_x << ' ';
        }
        cout << '\n';
    }
