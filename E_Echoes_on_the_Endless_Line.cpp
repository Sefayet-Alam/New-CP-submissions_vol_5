...
int main()
{
    ...
    while (t--)
    {
        ...
        while (q--)
        {
            ll pos;
            cin>>pos;
            auto rl=lower_bound(all(a),pos+l+1)-a.begin();
            auto rr=upper_bound(all(a),pos+r)-a.begin();
            rr--;
            ll ans=0;
            ll ans2=0;
            if(a[rl]>=pos+(l+1) && a[rr]<=pos+r){
                ans+=rr-rl+1;
                ans2+=(pref[rr]);
                if(rl){
                    ans2-=pref[rl-1];
            ...
            auto l2=lower_bound(all(a),pos-(r))-a.begin();
            auto r2=upper_bound(all(a),pos-(l+1))-a.begin();
            r2--;
            ll ans3=0;
            ll ans4=0;
            if(a[l2]>=pos-(r) && a[r2]<=pos-(l+1)){
                ans3+=(r2-l2+1);
                ans4+=(r2-l2+1)*pos;
                ans4-=pref[r2];
                if(l2){
