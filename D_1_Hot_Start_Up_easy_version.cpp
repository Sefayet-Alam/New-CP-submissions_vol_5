...
ll func(ll i, ll last)
{
    ...
    if (i == 0)
    {
        ret = min(ret, x[a[i]] + func(i + 1, last));
        ret = min(ret, x[a[i]] + func(i + 1, a[i]));
    }
    else
    {
        if (a[i] == a[i - 1] && a[i] == last)
        {
            ret = min(ret, y[a[i]] + func(i + 1, last));
            // ret = min(ret, y[a[i]] + func(i + 1, a[i - 1]));
        }
        else if (a[i] == last)
        {
            ret = min(ret, y[a[i]] + func(i + 1, a[i - 1]));
        ...
        {
            ret = min(ret, y[a[i]] + func(i + 1, last));
            ret = min(ret, x[a[i]] + func(i + 1, a[i - 1]));
        }
        else
        {
            ret = min(ret, x[a[i]] + func(i + 1, last));
