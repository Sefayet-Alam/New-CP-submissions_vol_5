...
int main()
{
    ...
    while (t--)
    {
        ...
        for (ll i = 0; i < n; i++)
        {
            if (aa[i].first > aa[i].second && bb[i].first > bb[i].second)
            {

                ll cur = 0;
                ll ag = aa[i].first - aa[i].second;
                cur += ag;
                ll bg = bb[i].first - bb[i].second;
                cur += bg;
                if (aa[i].second)
                    cur += aa[i].second;
                ans += cur;
            ...
            else if (bb[i].first > bb[i].second)
            {
                ll cur = 0;
                ll bg = bb[i].first - bb[i].second;
                cur += bg;
            ...
            else if (aa[i].first > aa[i].second)
            {
                ll ag = aa[i].first - aa[i].second;
                ans += ag;
            }
