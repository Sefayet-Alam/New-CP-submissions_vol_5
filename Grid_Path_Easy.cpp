...
int main()
{
    ...
    while (t--)
    {
        ...
        while (q--)
        {
            ...
            cin >> x >> y;
            y--;
            // updates x,y th position
            // x=1 means updated s string
            // x=2 updated p string
            // flips the yth bit
            // use segment tree, update segment tree to optimize my code
